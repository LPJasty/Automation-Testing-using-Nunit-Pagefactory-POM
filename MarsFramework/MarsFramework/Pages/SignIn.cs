...
namespace MarsFramework.Pages
{
    class SignIn
    {
        ...
        [FindsBy(How = How.XPath, Using = "/html/body/div[2]/div/div/div[1]/form/div[1]/input")]
        private IWebElement Email { get; set; }

        //Finding the Password Field
        [FindsBy(How = How.XPath, Using = "/html/body/div[2]/div/div/div[1]/form/div[2]/input")]
        private IWebElement Password { get; set; }

        //Finding the Login Button
        [FindsBy(How = How.XPath, Using = "/html/body/div[2]/div/div/div[1]/form/div[4]/button")]
